...
const _excluded$5 = ["children", "className", "defaultExpanded", "disabled", "disableGutters", "expanded", "onChange", "square", "TransitionComponent", "TransitionProps"];
...
const AccordionSummary = /*#__PURE__*/React.forwardRef(function AccordionSummary(inProps, ref) {
  ...
  const {
    ...
    expanded,
    toggle
  } = React.useContext(AccordionContext$1);
...
const CustomAccordian = (props) => {
    const [expanded, setExpanded] = useState(props?.isChildren ? false : 0);
    const handleAccordianChange = (panel) => (_event, isExpanded) => {
        setExpanded(isExpanded ? panel : false);
    };
    return (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsx(Box$1, { sx: { width: "100%" }, children: Object.entries(props?.data).map(([key, value], index) => {
                return (jsxRuntimeExports.jsxs(Accordion$1, { sx: {
                        px: 2,
                        width: "auto",
                        paddingBottom: "5px",
                        ...
                        "&:before": {
                            display: "none",
                    ...
                    }, disableGutters: true, elevation: 0, expanded: expanded === index, onChange: handleAccordianChange(index), children: [jsxRuntimeExports.jsx(AccordionSummary$1, { sx: {
                                ...
                                fontSize: "16px",
                            }, expandIcon: expanded === index ? (props?.removeIcon ? (props.removeIcon) : (jsxRuntimeExports.jsx(Typography$1, { sx: { fontSize: "22px", color: props?.headerColor }, children: "-" }))) : props?.addIcon ? (props.addIcon) : (jsxRuntimeExports.jsx(Typography$1, { sx: { fontSize: "22px", color: props?.headerColor }, children: "+" })), id: key, children: key }), jsxRuntimeExports.jsx(Box$1, { children: jsxRuntimeExports.jsx(AccordionDetails$1, { sx: {
                                    display: "flex",
                                    flexDirection: "column",
                                    rowGap: 2,
                                    py: 2,
                                    ml: 2,
                                }, children: value.accordianContent.map((item, index) => {
                                    return (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsxs(Box$1, { sx: {
                                                width: "100%",
                                                display: "flex",
                                                rowGap: 5,
                                                position: "relative",
                                                        ...
                                                        left: "-21px",
                                                        top: "0%",
                                                        bottom: value.accordianContent.length - 1 === index
                                                            ? "24px"
                                                            : "-19px",
                                                        ...
                                                        flexGrow: 0,
                                                        zIndex: 6,
                                                    } }), jsxRuntimeExports.jsx(Box$1, { sx: {
                                                        boxSizing: "border-box",
                                                        position: "absolute",
                                                        width: "16px",
                                                        height: "8px",
                                                        ...
                                                        flexGrow: 0,
                                                        zIndex: 2,
                                                    } }), jsxRuntimeExports.jsxs(Box$1, { sx: { width: "100%" }, children: [item?.title && (jsxRuntimeExports.jsx(Typography$1, { sx: {
                                                                color: props?.color || "black",
                                                                fontSize: props?.fontSize || "14px",
                                                                fontWeight: props?.fontWeight || 450,
                                                            }, children: item?.title })), item?.component && item.component, item?.isChildren && (jsxRuntimeExports.jsx(CustomAccordian, { ...props, isChildren: true, data: item?.children || {} }))] })] }, index) }));
                                }) }, index) })] }, index));
            }) }) }));
};
...
export { App, CustomAccordian, CustomAccordian as default };
